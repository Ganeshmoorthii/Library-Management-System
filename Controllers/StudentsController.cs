...
public class StudentsController : ControllerBase
{
    ...
    public async Task<IActionResult> getStudents()
    {
        var students = await _repository.StudentService.GetAllStudentsAsync();
        return Ok(students);
    }
    [HttpGet("{id}")]
    public async Task<IActionResult> getStudentById(int id)
    {
        var student = await _repository.StudentService.GetStudentByIdAsync(id);
        if (student == null)
            return NotFound();
        return Ok(student);
    }
    ...
    public async Task<IActionResult> createStudent([FromBody] Student student)
    {
        _repository.StudentService.CreateStudentAsync(student);
    ...
    public async Task<IActionResult> updateStudent([FromBody] Student student)
    {
        _repository.StudentService.UpdateStudentAsync(student);
        await _repository.SaveAsync();
        return Ok("Student Updated Successfully");
    }
    [HttpDelete("{id}")]
    public async Task<IActionResult> deleteStudent(int id)
    {
        _repository.StudentService.DeleteStudentAsync(id);
        await _repository.SaveAsync();
        return Ok("Student Deleted Successfully");
    }
}
